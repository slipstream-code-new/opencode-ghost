...
| `artifact.evidence.opencode_tui_certified_transcript` | `artifact` | `generated` | `provisional` | `evidence/traceability/opencode_source.tui_certified.permission_view.jsonl` |
